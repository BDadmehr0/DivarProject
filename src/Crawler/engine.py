...
SEARCH_FILTERS = {
    'form_data': {
        'data': {
            ...
            'districts': {'repeated_string': {'value': ['178',"4148","4177",],},},
        },
    },
    'server_payload': {
...
if first_res:
    ...
    info_layer = first_res.get("action_log", {}).get("server_side_info", {}).get("info", {})
    ...
    while has_next and pagination_data:
        ...
        if current_res:
            ...
            new_info_layer = current_res.get("action_log", {}).get("server_side_info", {}).get("info", {})
